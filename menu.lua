...
function scene:create( event )
	...
	zander.y = display.contentCenterY + yInset*5.5
	zander.xScale = 0.35
	zander.yScale =0.35
	sceneGroup:insert(zander)
	local speech = display.newImage("zanders/speech.png")
	speech.x =display.contentCenterX + xInset*3.2
	speech.y =display.contentCenterY + yInset*4.1
	speech.xScale =0.6
	speech.yScale =0.3
	...
	{
		parent = telGroup,
		text = "Hello Slimkop, kies jou \nspeletjie en leer tel.",
	...
	zanderTxt.x =display.contentCenterX + xInset*2
	zanderTxt.y =display.contentCenterY + yInset*3.5
